    ...
    <div class="sm:mx-auto sm:w-full sm:max-w-sm">
        ...
        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            <form wire:submit="register" class="space-y-6">
                <div>
                    <label for="name" class="block text-sm font-medium leading-6 text-gray-900 dark:text-gray-300">{{ __('Full Name') }}</label>
                    <div class="mt-2">
                        <input wire:model="name" id="name" name="name" type="text" autocomplete="name" required class="block w-full rounded-md border-0 py-1.5 text-gray-900 dark:text-white bg-white dark:bg-slate-900 shadow-sm ring-1 ring-inset ring-gray-300 dark:ring-slate-700 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6">
                    </div>
                ...
                <div class="flex items-center">
                    <input wire:model="terms" id="terms" name="terms" type="checkbox" required class="h-4 w-4 rounded border-gray-300 text-blue-600 focus:ring-blue-600 bg-white dark:bg-slate-900">
                    <label for="terms" class="ml-3 block text-sm leading-6 text-gray-900 dark:text-gray-300">
                        {{ __('I agree to the') }} <a href="#" class="font-semibold text-blue-600 hover:text-blue-500">{{ __('Terms') }}</a> {{ __('and') }} <a href="#" class="font-semibold text-blue-600 hover:text-blue-500">{{ __('Privacy Policy') }}</a>.
                    </label>
                </div>
            ...
            <div class="mt-10">
                <div class="relative">
                    ...
                    <div class="relative flex justify-center text-sm font-medium leading-6">
                        <span class="bg-white dark:bg-slate-950 px-6 text-gray-900 dark:text-gray-400">{{ __('Or sign up with') }}</span>
                    </div>
                </div>
            ...
            <p class="mt-10 text-center text-sm text-gray-500 dark:text-gray-400">
                ...
                <a href="/login" class="font-semibold leading-6 text-blue-600 hover:text-blue-500" wire:navigate>{{ __('Sign in') }}</a>
            </p>
        </div>
    </div>
</div>
